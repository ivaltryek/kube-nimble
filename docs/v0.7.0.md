...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#nimblespecingress">ingress</a></b></td>
        <td>object</td>
        <td>
          Spec for Ingress Object<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>map[string]string</td>
        <td>
          annotations to be applied on Ingress Object<br/>
          <br/>
            <i>Default</i>: map[app.kubernetes.io/managed-by:kube-nimble]<br/>
        </td>
        <td>false</td>
        ...
        <td><b><a href="#nimblespecingressrulesindex">rules</a></b></td>
        <td>[]object</td>
        <td>
...
<sup><sup>[↩ Parent](#nimblespecingress)</sup></sup>
